...
<p>Click to ask the LLM for a single-sentence photographic prompt referencing NPC's environment, mood, behavior, etc.</p>
<form method="POST">
...
{% if scene_image_prompt %}
  <hr>
  <h4>Scene Prompt</h4>
  <p>Edit or refine the prompt, then generate the final image using Replicate below.</p>
  <form method="POST">
